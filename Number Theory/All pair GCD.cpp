...
/** Problem: You're given an array with n(<=1e5) elements where a[i]<=1e5. Yo've to
answer Q(<=1e5) query. In each query, you'll given an integer g. You have to answer
how many pairs (i,j) exist where GCD(a[i] , a[j])=g & i!=j. **/
