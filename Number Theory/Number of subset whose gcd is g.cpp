...
/** You're given an array with n elements. You have to answer q query. In each query,
you'll given an integer g. You have to count number of subset those GCD = g **/
