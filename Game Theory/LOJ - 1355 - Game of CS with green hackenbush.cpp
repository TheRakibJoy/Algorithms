...
/** Firstly, try to convert this problem in green hackenbush. In this problem,
if we cut an edge of lower level then the upper level edge will be disconnected.
But if the edge cost > 1 then the scenerio is different. We can consider an edge[u,v] of
weight x>1 equal to x edge of 1 unit from from node u. Then, all other thing is
green hackebush **/
