...
/** Problem: You're given a graph with n nodes & m edges. You also given some robot
factory in some of the city/node of the given graph. A robot can go to a city from
another city with 1 seconds. Each factory can supply infinite robot at the same time.
And a robot will destroy a city if it has not destroyed yet. For each city, find
minimum time to be destroyed! **/
