...
/**
This is an Edge cover problem
Problem: Minimum number of guard need to cover all the vertex in a DAG.
Solution: Solution of edge cover = n - mxBPM
**/

int n,e,Left[1005],Right[1005],vis[1005];
vi graph[1005];
void Clean()
{
    for(int i=0 ; i<=n ; i++)
