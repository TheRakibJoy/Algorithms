...
/** Problem: Stars & bars theorem problem
    Solution of SecondTest:
    a+b+c+d+e+f+g = 30 ; where, a,b,c,d,e,f,g>=1

    (1+a`)+(1+b`)+(1+c`)+(1+d`)+(1+e`)+(1+f`)+(1+g`) = 30
    So, a`+b`+c`+d`+e`+f`+g` = 30-7 = 23
    So, ans = nCr(23+7-1 , 7-1)

    Here, we've to calculate the nCr in nlogn complexity.
**/
