...
f(n) = f(n-1) + f(n-2). You're given two integers n & m. You've to calculate (f(n)+f(n+1)+f(n+2)+----+f(m))%mod
...
int fib[4] = {0 , 1 , 1 , 2},sum[3] = {0 , 1 , 2};
void Solve(int t)
{
    ll lft,rgt,lans,rans,ans;
    scln2(lft , rgt);
    fib[0] = sum[0] = 0;
    fib[1] = sum[1] = fib[2] = 1;
    ...
    matrix A,B,ret;
    A.row = A.col = 5;
    A.mat[1][1] = 0; A.mat[1][2] = 1; A.mat[1][3] = 0; A.mat[1][4] = 0; A.mat[1][5] = 0;
    A.mat[2][1] = 0; A.mat[2][2] = 0; A.mat[2][3] = 1; A.mat[2][4] = 0; A.mat[2][5] = 0;
    A.mat[3][1] = 0; A.mat[3][2] = 1; A.mat[3][3] = 1; A.mat[3][4] = 0; A.mat[3][5] = 0;
    A.mat[4][1] = 0; A.mat[4][2] = 0; A.mat[4][3] = 0; A.mat[4][4] = 0; A.mat[4][5] = 1;
    A.mat[5][1] = 0; A.mat[5][2] = 0; A.mat[5][3] = 1; A.mat[5][4] = 0; A.mat[5][5] = 1;
