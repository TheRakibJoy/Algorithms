...
int main()
{
    int i,j,k,t,T,ans,len1,len2,len3,n;
    scin(T);
    RUN_CASE(t,T)
    {
        ans = 0;
        str = "";
        char s1[5005],s2[5005],s3[5005];
        sc("%s %s %s",s1,s2,s3);
        len1 = strlen(s1);
        len2 = strlen(s2);
        len3 = strlen(s3);
        ...
        for(i=1 ; i<n-1 ; i++){
            ...
            if(arr[i-1].idx < len1)
                fg1 = 1;
            else if(arr[i-1].idx > len1 && arr[i-1].idx<1+len1+len2)
                fg2 = 1;
            else if(arr[i-1].idx > 1+len1+len2 && arr[i-1].idx<len1+len2+len3+3)
                fg3 = 1;

            if(arr[i].idx < len1)
                fg1 = 1;
            else if(arr[i].idx > len1 && arr[i].idx<1+len1+len2)
                fg2 = 1;
            else if(arr[i].idx > 1+len1+len2 && arr[i].idx<len1+len2+len3+3)
                fg3 = 1;
