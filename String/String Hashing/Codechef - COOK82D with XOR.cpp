...
ll cxor[2000005],edges[2000005];
map<ll,ll>orgtorandom;
map<ll,ll>randomtoorg;
int main()
{
    ll i,j,k,n,m,q,l,r,u,v,x,y,rangexor;
    scln2(n,m);
    for(i=1 ; i<=n ; i++){
        if(orgtorandom[i] == 0){
            while(1){
