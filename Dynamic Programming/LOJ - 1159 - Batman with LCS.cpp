...
int LCS(int pos1,int pos2,int pos3)
{
    ...
    {
        if(s1[pos1]==s2[pos2] && s2[pos2]==s3[pos3])
            return dp[pos1][pos2][pos3] = 1+LCS(pos1+1,pos2+1,pos3+1);
        else
        {
            int ret1 = LCS(pos1,pos2,pos3+1);
            int ret2 = LCS(pos1,pos2+1,pos3);
            int ret3 = LCS(pos1+1,pos2,pos3);
            return dp[pos1][pos2][pos3] = max(ret1 , max(ret2,ret3));
        }
    }
}
int main()
