...
int Kadane()    /** Calculate maximum SubArray Sum ; You have to take at least one element **/
{
    int mx_ending_here = ara[1] , mx_so_far = ara[1];
    for(int i=2 ; i<=n ; i++){
        mx_ending_here = max(ara[i] , mx_ending_here+ara[i]);
