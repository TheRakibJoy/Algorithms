...
void init(int node,int b,int e)
{
    ...
    else if(tree[left].mx1 < tree[right].mx1)
    {
...
info query(int node, int b, int e, int i, int j)
{
    ...
    {
        temp.mx1=p1.mx1;
        temp.mx2=max(p2.mx1,max(p1.mx2,p2.mx2));
    }
    else if(p1.mx1 < p2.mx1)
    {
        temp.mx1=p2.mx1;
        temp.mx2=max(p1.mx1,max(p1.mx2,p2.mx2));
    }
    else
    {
        temp.mx1=p1.mx1;
